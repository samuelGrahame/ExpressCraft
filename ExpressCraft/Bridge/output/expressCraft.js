...
Bridge.assembly("ExpressCraft", function ($asm, globals) {
    ...
    Bridge.define("ExpressCraft.Form", {
        ...
        ctor: function () {
            ...
            this.getBody().addEventListener("mouseleave", Bridge.fn.bind(this, $asm.$.ExpressCraft.Form.f20));
    ...
    Bridge.define("ExpressCraft.SplitControlContainer", {
        ...
        ctor: function () {
            ...
            ExpressCraft.Helper.appendChildren$2(this, [this.panel1, this.splitter, this.panel2]);
        },
